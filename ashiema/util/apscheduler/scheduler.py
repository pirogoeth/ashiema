...
from ashiema.util.apscheduler.util import *
from ashiema.util.apscheduler.triggers import SimpleTrigger, IntervalTrigger, CronTrigger
from ashiema.util.apscheduler.jobstores.ram_store import RAMJobStore
from ashiema.util.apscheduler.job import Job, MaxInstancesReachedError
from ashiema.util.apscheduler.events import *
from ashiema.util.apscheduler.threadpool import ThreadPool
...
class Scheduler(object):
    ...
    def configure(self, gconfig={}, **options):
        ...
        # Set general options
        config = combine_opts(gconfig, 'ashiema.util.apscheduler.', options)
    ...
    def add_jobstore(self, jobstore, alias, quiet=False):
        ...
        :type jobstore: instance of
            :class:`~ashiema.util.apscheduler.jobstores.base.JobStore`
        :type alias: str
        """
    ...
    def add_job(self, trigger, func, args, kwargs, jobstore='default',
        ...
        :rtype: :class:`~ashiema.util.apscheduler.job.Job`
        """
    ...
    def get_jobs(self):
        ...
        :return: list of :class:`~ashiema.util.apscheduler.job.Job` objects
        """
        self._jobstores_lock.acquire()
        try:
            jobs = []
