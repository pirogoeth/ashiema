...
import collections, malibu, re, traceback
...
class Structure(object):
    ...
    def log_debug(*args):
        ...
        [LOG.debug(line) for line in args]

    @staticmethod
    def log_info(*args):

        [LOG.info(line) for line in args]

    @staticmethod
    def log_warning(*args):

        [LOG.warning(line) for line in args]

    @staticmethod
    def log_error(*args):

        [LOG.error(line) for line in args]

    @staticmethod
    def log_critical(*args):

        [LOG.critical(line) for line in args]

    def __init__(self, token):

        # The token instance from which this structure was derived.
        self._token = token
...
class Type(Structure):
    ...
    def __init__(self, token, typedata):
...
class User(Structure):
    ...
    def __init__(self, token, userstring = None, nick = None, ident = None, host = None):
