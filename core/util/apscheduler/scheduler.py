...
from core.util.apscheduler.util import *
from core.util.apscheduler.triggers import SimpleTrigger, IntervalTrigger, CronTrigger
from core.util.apscheduler.jobstores.ram_store import RAMJobStore
from core.util.apscheduler.job import Job, MaxInstancesReachedError
from core.util.apscheduler.events import *
from core.util.apscheduler.threadpool import ThreadPool
...
class Scheduler(object):
    ...
    def configure(self, gconfig={}, **options):
        ...
        # Set general options
        config = combine_opts(gconfig, 'core.util.apscheduler.', options)
    ...
    def add_jobstore(self, jobstore, alias, quiet=False):
        ...
        :type jobstore: instance of
            :class:`~core.util.apscheduler.jobstores.base.JobStore`
        :type alias: str
        """
    ...
    def add_job(self, trigger, func, args, kwargs, jobstore='default',
        ...
        :rtype: :class:`~core.util.apscheduler.job.Job`
        """
    ...
    def get_jobs(self):
        ...
        :return: list of :class:`~core.util.apscheduler.job.Job` objects
        """
        self._jobstores_lock.acquire()
        try:
            jobs = []
